...
# copy patched libcurl include to build folder
# curl-$BUNDLED_LIBCURL_VERSION is downloaded during previous make
cp -r curl-$BUNDLED_LIBCURL_VERSION/include $build_folder/include
