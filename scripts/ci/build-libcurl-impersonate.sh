...
# https://github.com/evocode/curl-impersonate/blob/main/Makefile.in#LL19C17-L19C28
CURL_VERSION="7.84.0"
...
cp -r $2/source/$1/curl-$CURL_VERSION/include $build_folder/include
